...
<div id="header">
	...
	<div id="content">
		...
		<div id="dynamic_content">
			<form id="formulaire" action="index.php?action=addGiftList" method="POST">
				<ul class="list_normal">
					<li><span>Nom cadeau : </span><input type="text" name="nomCadeau" required></li>
					<li><span>Lien cadeau : </span><input type="text" name="lienCadeau" required></li>
					<li><span>Description : </span><input type="text" name="desc" required></li>
