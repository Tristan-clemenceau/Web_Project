...
<div id="header">
	...
	<div id="content">
		...
		<div id="dynamic_content">
            <h1>Informations Cadeau</h1>
				<ul class="list_normal">
                <?php
                    $row = mysqli_fetch_assoc($GiftInfo);
                    echo '<li><span>Nom : </span> '.$row['nomCadeau'].'</li>';
                    echo '<li><span>Description : </span> '.$row['descCadeau'].'</li>';
                    echo '<li><span>Lien : </span> <a href="'.$row['lienCadeau'].'">cliquez ici</a></li>';
                    echo '<li><a href="index.php?action=book&id='.$row['id_Cadeau'].'">reserver</a></li>';
                ?>
				</ul>
		</div>
	</div>
