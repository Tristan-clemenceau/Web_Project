<?php $title = "Acceuil";
	  $content ="Mon Compte";?>
<?php ob_start(); ?>
<link rel="stylesheet" type="text/css" href="Public/Css/defaultMember_page.css">
	...
	<div id="content">
		...
		<div id="dynamic_content">
			<ul class="list_normal">
				...
				<li><span>Nom : </span><?php echo $_SESSION['member']->getNom();?></li>
				<li><span>Prenom : </span><?php echo $_SESSION['member']->getPrenom();?></li>
			</ul>
		</div>
	</div>
	<div id="mid_box">
